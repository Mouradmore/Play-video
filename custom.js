...
<img class="thumbnail" src="${video_details[index][1]}.jpg">
    </div>
...
<div class='right_time_title'><span>${video_details[index][2]}</span> 
<span class="point" style ="font-size: 4px !important; padding: 0px 5px;"><i class='fas fa-circle'></i></span> <span>${video_details[index][3]} </span></div>
            </div>
        </div>
    </div>
</div>
...
<div onclick="PlayPause()" class="overly_poster">
<i id="playPause_btn" class="fas fa-pause"></i></div>

<div class="range_wrapper">
<div class="inp_range">
<input value="0" min="0" max="100" type="range" name="range" id="rangeId" step="1"></div>
